...
import { PencilTool, EraserTool, SprayTool, FillTool, TextTool } from './basicTools';
import { RectangleTool, CircleTool, LineTool, TriangleTool, ArcTool } from './objectTools';
...
export class ToolManager {
    ...
    private updateTriangleTypeVisibility(toolName: string): void {
        ...
        if (triangleTypeSelect) {
            triangleTypeSelect.style.display = toolName === 'triangle' ? 'block' : 'none';
        }
    }
